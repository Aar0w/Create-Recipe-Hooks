...
// Fabric callback fired when a Mechanical Saw fells a whole tree: one event per tree,
// with log and leaf counts. Lone blocks fire CreateBlockProcessedCallback instead,
// never both. Server side only, not cancellable.
@FunctionalInterface
