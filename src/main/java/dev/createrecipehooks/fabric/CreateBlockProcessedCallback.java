...
// Fabric callback fired when a Drill breaks a block, a Harvester cuts a plant, or a Saw cuts a lone block that is not part of a tree.
// Tree felling fires CreateTreeCutCallback instead, never both. Server side only, not cancellable.
@FunctionalInterface
